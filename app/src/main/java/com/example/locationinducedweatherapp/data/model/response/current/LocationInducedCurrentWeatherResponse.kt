...
import com.example.locationinducedweatherapp.data.model.response.forecast.CloudPercentage
...
import com.example.locationinducedweatherapp.data.model.response.forecast.WeatherDescription
import com.example.locationinducedweatherapp.data.model.response.forecast.WindDescription
...
data class LocationInducedCurrentWeatherResponse (
    ...
    var cloud: CloudPercentage = CloudPercentage(),
