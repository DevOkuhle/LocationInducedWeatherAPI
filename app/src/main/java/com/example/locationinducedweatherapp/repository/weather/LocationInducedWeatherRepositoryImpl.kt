...
class LocationInducedWeatherRepositoryImpl @Inject constructor(private val openWeatherAPI: OpenWeatherAPI, private val apiConfigurations: APIConfigurations):
    LocationInducedWeatherRepository {
